...
<script type="text/javascript" src="views/admin/js/plugins/jquery.flot.min.js"></script>
<script type="text/javascript" src="views/admin/js/plugins/jquery.flot.resize.min.js"></script>
<script type="text/javascript" src="views/admin/js/plugins/jquery.slimscroll.js"></script>
<script type="text/javascript" src="views/admin/js/custom/general.js"></script>
<script type="text/javascript" src="views/admin/js/custom/dashboard.js"></script>
...
<div class="bodywrapper">
    <div class="topheader">
        ...
        <div class="right">
            ...
            <div class="userinfo">
            	<img src="views/admin/images/thumbs/avatar.png" alt="" />
                <span>管理员</span>
            </div><!--userinfo-->
            
            <div class="userinfodrop">
            	<div class="avatar">
                	<a href=""><img src="views/admin/images/thumbs/avatarbig.png" alt="" /></a>
                ...
                <div class="userdata">
                    ...
                    <ul>
                        ...
                        <li><a href="accountsettings.html">帐号设置</a></li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <ul class="hornav">
                ...
                <li><a href="#activities">最新活动</a></li>
            </ul>
        </div><!--pageheader-->
